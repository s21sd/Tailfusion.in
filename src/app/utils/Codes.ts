      ...
      <div class="flex">
        <div class="card">
          <div class="card-content">
            <h2>CATEGORY</h2>
            <h1>Raclette Blueberry Nextious Level</h1>
        ...
        <div class="card">
          <div class="card-content">
            <h2>CATEGORY</h2>
            <h1>Ennui Snackwave Thundercats</h1>
            <p>Photo booth fam kinfolk cold-pressed sriracha leggings jianbing microdosing tousled waistcoat.</p>
            <a href="#">Learn More
              <svg viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round">
                <path d="M5 12h14"></path>
        ...
        <div class="card">
          <div class="card-content">
            <h2>CATEGORY</h2>
            <h1>Selvage Poke Waistcoat Godard</h1>
            <p>Photo booth fam kinfolk cold-pressed sriracha leggings jianbing microdosing tousled waistcoat.</p>
            <a href="#">Learn More
              <svg viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round">
                <path d="M5 12h14"></path>
    ...
    <div class="blog-posts">
      <div class="blog-post">
        ...
        <div class="post-content">
          <h2 class="post-category">CATEGORY</h2>
          <h1 class="post-title">The Catalyzer</h1>
          <p class="post-description">Photo booth fam kinfolk cold-pressed sriracha leggings jianbing microdosing tousled waistcoat.</p>
          <div class="post-actions">
            <a href="#" class="learn-more">Learn More
              <svg class="icon-arrow" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round">
                <path d="M5 12h14"></path>
                <path d="M12 5l7 7-7 7"></path>
              </svg>
            </a>
            <span class="post-views">
              <svg class="icon-eye" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24">
                <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
                <circle cx="12" cy="12" r="3"></circle>
              </svg>1.2K
            </span>
            <span class="post-comments">
              <svg class="icon-comment" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24">
                <path d="M21 11.5a8.38 8.38 0 01-.9 3.8 8.5 8.5 0 01-7.6 4.7 8.38 8.38 0 01-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 01-.9-3.8 8.5 8.5 0 014.7-7.6 8.38 8.38 0 013.8-.9h.5a8.48 8.48 0 018 8v.5z"></path>
              </svg>6
            </span>
          </div>
      ...
      <div class="blog-post">
        <div class="post-image">
          <img src="https://dummyimage.com/721x401" alt="blog">
        </div>
        <div class="post-content">
          <h2 class="post-category">CATEGORY</h2>
          <h1 class="post-title">The 400 Blows</h1>
          <p class="post-description">Photo booth fam kinfolk cold-pressed sriracha leggings jianbing microdosing tousled waistcoat.</p>
          <div class="post-actions">
            <a href="#" class="learn-more">Learn More
              <svg class="icon-arrow" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round">
      ...
      <div class="blog-post">
        <div class="post-image">
          <img src="https://dummyimage.com/722x402" alt="blog">
        </div>
        <div class="post-content">
          <h2 class="post-category">CATEGORY</h2>
          <h1 class="post-title">Shooting Stars</h1>
          <p class="post-description">Photo booth fam kinfolk cold-pressed sriracha leggings jianbing microdosing tousled waistcoat.</p>
          <div class="post-actions">
            <a href="#" class="learn-more">Learn More
              <svg class="icon-arrow" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round">
...
<head>
    ...
    <style>
        ...
        .body-section {
            background-color: #f7fafc;
            /* body background color if needed */
        }
...
<body>
    <section class="text-secondary body-section">
        <div class="container padding-section">
            <div class="flex-container text-center">
                <div class="half-width mb-section padding-item">
                    <div class="image-container overflow-hidden">
                        <img alt="content" class="image-full" src="https://dummyimage.com/1201x501">
                    </div>
                    <h2 class="title text-large font-medium text-primary mt-medium mb-small">Buy YouTube Videos</h2>
                    <p class="description text-base">Williamsburg occupy sustainable snackwave gochujang. Pinterest
                        cornhole brunch, slow-carb neutra irony.</p>
                    <button
                        class="button flex-center mt-medium text-white bg-primary border-0 padding-button focus:outline-none hover:bg-primary-dark rounded">Button</button>
                </div>
                <div class="half-width mb-section padding-item">
                    <div class="image-container overflow-hidden">
                        <img alt="content" class="image-full" src="https://dummyimage.com/1202x502">
                    </div>
                    <h2 class="title text-large font-medium text-primary mt-medium mb-small">The Catalyzer</h2>
                    <p class="description text-base">Williamsburg occupy sustainable snackwave gochujang. Pinterest
                        cornhole brunch, slow-carb neutra irony.</p>
                    <button
                        class="button flex-center mt-medium text-white bg-primary border-0 padding-button focus:outline-none hover:bg-primary-dark rounded">Button</button>
        ...
        <div class="container">
            ...
            <div class="content-container">
                ...
                <p>Chillwave portland ugh, knausgaard fam polaroid iPhone. Man braid swag typewriter affogato, hella
                    selvage wolf narwhal dreamcatcher.</p>
                <div class="input-container flex w-full md:justify-start justify-center items-end">
                    <div class="relative mr-4 lg:w-full xl:w-1/2 w-2/4">
                        <input type="text" id="hero-field" name="hero-field" class="input-field" />
                    </div>
                    <button class="button-primary">Button</button>
                </div>
                <p class="text-sm mt-2 text-gray-500 mb-8 w-full">Neutra shabby chic ramps, viral fixie.</p>
                <div class="button-group flex lg:flex-row md:flex-col">
                    <button
                        class="button-secondary bg-gray-100 inline-flex py-3 px-5 rounded-lg items-center hover:bg-gray-200 focus:outline-none">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="icons" viewBox="0 0 512 512">
                            <path
                        ...
                        <span class="ml-4 flex items-start flex-col leading-none">
                            ...
                            <span class="heading-two title-font font-medium">Google Play</span>
                        </span>
                    </button>
                    <button
                        class="button-secondary bg-gray-100 inline-flex py-3 px-5 rounded-lg items-center lg:ml-4 md:ml-0 ml-4 md:mt-4 mt-0 lg:mt-0 hover:bg-gray-200 focus:outline-none">
                        ...
                        <span class="ml-4 flex items-start flex-col leading-none">
                            ...
                            <span class="heading-two title-font font-medium">App Store</span>
                        </span>
                    </button>
                </div>
            </div>
    ...
    [
        {
            Tailwind: `<div className="w-80 mx-auto h-128 bg-black shadow-lg rounded-lg p-8">
                                ...
                                <form className="flex flex-col gap-4 mb-4 text-black">
                                    ...
                                    />
                                    <button className="rounded-full bg-indigo-500 hover:bg-indigo-600 text-white py-3 shadow-md ">Register</button>
                                </form>
                                <p className="text-center text-xs text-gray-500">
...
<body>
    <section class="contact-container">
        <div class="contact-header">
            ...
            <p class="contact-description">Whatever cardigan tote bag tumblr hexagon brooklyn asymmetrical gentrify.</p>
        </div>
    ...
    [
      ...
      <div className="container px-5 py-24 mx-auto">
        <div className="flex flex-col text-center w-full mb-20">
          ...
          <h1 className="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Discover New Experiences</h1>
                                ...
                                <div className="container px-5 py-24 mx-auto">
                                    <div className="flex flex-wrap w-full mb-20">
                                        <div className="lg:w-1/2 w-full mb-6 lg:mb-0">
                                            <h1 className="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">Innovative Solutions for Modern Challenges</h1>
                                        ...
                                        <div className="xl:w-1/4 md:w-1/2 p-4">
                                            <div className="bg-gray-100 p-6 rounded-lg">
                                                <img className="h-40 rounded w-full object-cover object-center mb-6" src="https://dummyimage.com/720x400" alt="Innovative Technology"/>
                                                    <h3 className="tracking-widest text-indigo-500 text-xs font-medium title-font">TECHNOLOGY</h3>
                                                    <h2 className="text-lg text-gray-900 font-medium title-font mb-4">Innovative Technology</h2>
                                        ...
                                        <div className="xl:w-1/4 md:w-1/2 p-4">
                                            <div className="bg-gray-100 p-6 rounded-lg">
                                                <img className="h-40 rounded w-full object-cover object-center mb-6" src="https://dummyimage.com/721x401" alt="Sustainable Solutions"/>
                                                    <h3 className="tracking-widest text-indigo-500 text-xs font-medium title-font">SUSTAINABILITY</h3>
                                                    <h2 className="text-lg text-gray-900 font-medium title-font mb-4">Sustainable Solutions</h2>
                                        ...
                                        <div className="xl:w-1/4 md:w-1/2 p-4">
                                            <div className="bg-gray-100 p-6 rounded-lg">
                                                <img className="h-40 rounded w-full object-cover object-center mb-6" src="https://dummyimage.com/722x402" alt="Expert Consulting"/>
                                                    <h3 className="tracking-widest text-indigo-500 text-xs font-medium title-font">CONSULTING</h3>
                                                    <h2 className="text-lg text-gray-900 font-medium title-font mb-4">Expert Consulting</h2>
                                        ...
                                        <div className="xl:w-1/4 md:w-1/2 p-4">
                                            <div className="bg-gray-100 p-6 rounded-lg">
                                                <img className="h-40 rounded w-full object-cover object-center mb-6" src="https://dummyimage.com/723x403" alt="Customized Solutions"/>
                                                    <h3 className="tracking-widest text-indigo-500 text-xs font-medium title-font">CUSTOMIZATION</h3>
                                                    <h2 className="text-lg text-gray-900 font-medium title-font mb-4">Customized Solutions</h2>
...
// This is the design code for the CTA I have component Code 11
...
// This is the design code for the Features I have component Code 12
export const designCodeForFeatures: any = [
    [
        {
            Tailwind: `<section className='text-gray-600'>
                                <div className="px-6 py-10 mx-auto">
                                    <h1 className="text-3xl font-semibold capitalize lg:text-4xl">explore our <br></br> awesome
                                        <span className="underline decoration-blue-500">Components</span></h1>
                                    ...
                                    <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-12 md:grid-cols-2 xl:grid-cols-3">
                                        <div className="p-8 space-y-3 border-2 border-blue-400 rounded-xl">
                                            ...
                                            <h1 className="text-2xl font-semibold text-gray-700 capitalize">elegant Dark Mode</h1>
                                            ...
                                            <a href="#"
                                                className="inline-flex p-2 text-blue-500 capitalize transition-colors duration-200 transform bg-blue-100 rounded-full ">
                                        ...
                                        <div className="p-8 space-y-3 border-2 border-blue-400  rounded-xl">
                                            ...
                                            <h1 className="text-2xl font-semibold text-gray-700 capitalize ">Easy to customiztions</h1>
                                        ...
                                        <div className="p-8 space-y-3 border-2 border-blue-400  rounded-xl">
                                            ...
                                            <h1 className="text-2xl font-semibold text-gray-700 capitalize ">Simple & clean designs</h1>
...
<body>
    ...
    <div className="container px-5 py-24 mx-auto">
      <div className="text-center mb-20">
        <h1 className="sm:text-3xl text-2xl font-medium text-center title-font text-gray-900 mb-4">Our Unique Features</h1>
      ...
      <div className="flex flex-wrap lg:w-4/5 sm:mx-auto sm:mb-2 -mx-2">
        <div className="p-2 sm:w-1/2 w-full">
          <div className="bg-gray-100 rounded flex p-4 h-full items-center">
            ...
            <span className="title-font font-medium">Seamless Integration</span>
          </div>
        </div>
        <div className="p-2 sm:w-1/2 w-full">
          <div className="bg-gray-100 rounded flex p-4 h-full items-center">
            ...
            <span className="title-font font-medium">User-Friendly Design</span>
          </div>
        </div>
        <div className="p-2 sm:w-1/2 w-full">
          <div className="bg-gray-100 rounded flex p-4 h-full items-center">
            ...
            <span className="title-font font-medium">Advanced Security</span>
          </div>
        </div>
        <div className="p-2 sm:w-1/2 w-full">
          <div className="bg-gray-100 rounded flex p-4 h-full items-center">
            ...
            <span className="title-font font-medium">Customizable Options</span>
          </div>
        </div>
        <div className="p-2 sm:w-1/2 w-full">
          <div className="bg-gray-100 rounded flex p-4 h-full items-center">
            ...
            <span className="title-font font-medium">24/7 Support</span>
          </div>
        </div>
        <div className="p-2 sm:w-1/2 w-full">
          <div className="bg-gray-100 rounded flex p-4 h-full items-center">
            ...
            <span className="title-font font-medium">Scalable Solutions</span>
          </div>
        </div>
      </div>
      <button className="flex mx-auto mt-16 text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">Learn More</button>
...
<body>
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="text-center mb-20">
      <h1 className="sm:text-3xl text-2xl font-medium text-center title-font text-gray-900 mb-4">Unique Handcrafted Items</h1>
      <p className="text-base leading-relaxed xl:w-2/4 lg:w-3/4 mx-auto">Discover a range of unique, handcrafted items that blend tradition with modernity. Our collection includes bespoke pieces that are perfect for any occasion.</p>
    </div>
    <div className="flex flex-wrap -m-4">
      <div className="p-4 lg:w-1/4 sm:w-1/2 w-full">
        <h2 className="font-medium title-font tracking-widest text-gray-900 mb-4 text-sm text-center sm:text-left">Artisanal Jewelry</h2>
      ...
      <div className="p-4 lg:w-1/4 sm:w-1/2 w-full">
        <h2 className="font-medium title-font tracking-widest text-gray-900 mb-4 text-sm text-center sm:text-left">Handmade Decor</h2>
        <nav className="flex flex-col sm:items-start sm:text-left text-center items-center -mb-1 space-y-2.5">
          <a>
            <span className="bg-indigo-100 text-indigo-500 w-4 h-4 mr-2 rounded-full inline-flex items-center justify-center">
              <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" className="w-3 h-3" viewBox="0 0 24 24">
      ...
      <div className="p-4 lg:w-1/4 sm:w-1/2 w-full">
        <h2 className="font-medium title-font tracking-widest text-gray-900 mb-4 text-sm text-center sm:text-left">Eco-Friendly Products</h2>
        <nav className="flex flex-col sm:items-start sm:text-left text-center items-center -mb-1 space-y-2.5">
          <a>
            <span className="bg-indigo-100 text-indigo-500 w-4 h-4 mr-2 rounded-full inline-flex items-center justify-center">
              <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" className="w-3 h-3" viewBox="0 0 24 24">
      ...
      <div className="p-4 lg:w-1/4 sm:w-1/2 w-full">
        <h2 className="font-medium title-font tracking-widest text-gray-900 mb-4 text-sm text-center sm:text-left">Gourmet Treats</h2>
        <nav className="flex flex-col sm:items-start sm:text-left text-center items-center -mb-1 space-y-2.5">
          <a>
            <span className="bg-indigo-100 text-indigo-500 w-4 h-4 mr-2 rounded-full inline-flex items-center justify-center">
              <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" className="w-3 h-3" viewBox="0 0 24 24">
...
`
    ...
    [
        {
            Tailwind: `<footer class="text-gray-600 body-font">
  <div class="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
    <div class="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
      <a class="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
        ...
        <span class="ml-3 text-xl">TailFusion</span>
      </a>
      <p class="mt-2 text-sm text-gray-500">Creating beautiful UIs with ease and efficiency.</p>
    </div>
    <div class="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
      <div class="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <nav class="list-none mb-10">
          <li>
            <a href="mailto:info@tailfusion.com" class="text-gray-600 hover:text-gray-800">info@tailfusion.com</a>
          </li>
          <li>
            <a href="tel:+1234567890" class="text-gray-600 hover:text-gray-800">+1 (234) 567-890</a>
          </li>
          <li>
            <a href="https://www.google.com/maps/place/TailFusion" target="_blank" class="text-gray-600 hover:text-gray-800">123 TailFusion St, UI City</a>
          </li>
        </nav>
      </div>
      <div class="lg:w-1/4 md:w-1/2 w-full px-4">
      ...
      <div class="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <nav class="list-none mb-10">
          <li>
            <a href="https://facebook.com/tailfusion" target="_blank" class="text-gray-600 hover:text-gray-800">Facebook</a>
          </li>
          <li>
            <a href="https://twitter.com/tailfusion" target="_blank" class="text-gray-600 hover:text-gray-800">Twitter</a>
          </li>
          <li>
            <a href="https://linkedin.com/company/tailfusion" target="_blank" class="text-gray-600 hover:text-gray-800">LinkedIn</a>
          </li>
          <li>
            <a href="https://instagram.com/tailfusion" target="_blank" class="text-gray-600 hover:text-gray-800">Instagram</a>
          </li>
        </nav>
      </div>
      <div class="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <nav class="list-none mb-10">
          <li>
            <p class="text-gray-600">Sign up for our newsletter to stay updated with the latest news and special offers.</p>
          </li>
          <li>
            <form action="#" method="post" class="mt-4">
              <input type="email" name="email" placeholder="Your Email" class="w-full px-4 py-2 text-gray-900 bg-gray-200 rounded-lg focus:outline-none" required>
              <button type="submit" class="mt-2 px-4 py-2 bg-indigo-500 text-white rounded-lg">Subscribe</button>
            </form>
          </li>
        </nav>
      </div>
  ...
  <div class="bg-gray-100">
    <div class="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
      <p class="text-gray-500 text-sm text-center sm:text-left">© 2024 TailFusion —
        <a href="https://twitter.com/tailfusion" rel="noopener noreferrer" class="text-gray-600 ml-1" target="_blank">@tailfusion</a>
      </p>
      <span class="inline-flex sm:ml-auto sm:mt-0 mt-2 justify-center sm:justify-start">
        <a class="text-gray-500 hover:text-gray-800" href="https://facebook.com/tailfusion" target="_blank">
          <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-5 h-5" viewBox="0 0 24 24">
            <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"></path>
          </svg>
        </a>
        <a class="ml-3 text-gray-500 hover:text-gray-800" href="https://twitter.com/tailfusion" target="_blank">
          <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-5 h-5" viewBox="0 0 24 24">
            <path d="M23 3a10.9 10.9 0 01-3.14 1.53 4.48 4.48 0 00-7.86 3v1A10.66 10.66 0 013 4s-4 9 5 13a11.64 11.64 0 01-7 2c9 5 20 0 20-11.5a4.5 4.5 0 00-.08-.83A7.72 7.72 0 0023 3z"></path>
          </svg>
        </a>
        <a class="ml-3 text-gray-500 hover:text-gray-800" href="https://linkedin.com/company/tailfusion" target="_blank">
          <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-5 h-5" viewBox="0 0 24 24">
            <rect width="20" height="20" x="2" y="2" rx="5" ry="5"></rect>
            <path d="M16 11.37A4 4 0 1112.63 8 4 4 0 0116 11.37zm1.5-4.87h.01"></path>
          </svg>
        </a>
        <a class="ml-3 text-gray-500 hover:text-gray-800" href="https://instagram.com/tailfusion" target="_blank">
    ...
    <footer class="footer">
        <div class="container">
            <div class="footer-content">
                <div class="footer-logo">
                    <p class="logo-link">
                        <span>TailFusion</span>
                    </p>
                    <p class="footer-description">Creating beautiful UIs with ease and efficiency.</p>
                </div>
                <div class="footer-section">
                    <h2>Contact Information</h2>
                    <nav>
                        <li><a href="mailto:info@tailfusion.com">info@tailfusion.com</a></li>
                        <li><a href="tel:+1234567890">+1 (234) 567-890</a></li>
                        <li><a href="https://www.google.com/maps/place/TailFusion" target="_blank">123 TailFusion St, UI
                                City</a></li>
                    </nav>
                </div>
                <div class="footer-section">
                ...
                <div class="footer-section">
                    <h2>Social Media</h2>
                    <nav>
                        <li><a href="https://facebook.com/tailfusion" target="_blank">Facebook</a></li>
                        <li><a href="https://twitter.com/tailfusion" target="_blank">Twitter</a></li>
                        <li><a href="https://linkedin.com/company/tailfusion" target="_blank">LinkedIn</a></li>
                        <li><a href="https://instagram.com/tailfusion" target="_blank">Instagram</a></li>
                    </nav>
                </div>
                <div class="footer-section">
                    <h2>Newsletter</h2>
                    <div class="newsletter">
                        <p>Sign up for our newsletter to stay updated with the latest news and special offers.</p>
        ...
        <div class="footer-bottom">
            <>© 2024 TailFusion —
                ...
                <div class="social-icons">
                    <a href="https://facebook.com/tailfusion" target="_blank">
                        <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            viewBox="0 0 24 24">
                            <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"></path>
                        </svg>
                    </a>
                    <a href="https://twitter.com/tailfusion" target="_blank">
                        <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            viewBox="0 0 24 24">
                            <path
                                d="M23 3a10.9 10.9 0 01-3.14 1.53 4.48 4.48 0 00-7.86 3v1A10.66 10.66 0 013 4s-4 9 5 13a11.64 11.64 0 01-7 2c9 5 20 0 20-11.5a4.5 4.5 0 00-.08-.83A7.72 7.72 0 0023 3z">
                    ...
                    <a href="https://linkedin.com/company/tailfusion" target="_blank">
                        <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                            stroke-width="2" viewBox="0 0 24 24">
                            <rect width="20" height="20" x="2" y="2" rx="5" ry="5"></rect>
                            <path d="M16 11.37A4 4 0 1112.63 8 4 4 0 0116 11.37zm1.5-4.87h.01"></path>
                    ...
                    <a href="https://instagram.com/tailfusion" target="_blank">
