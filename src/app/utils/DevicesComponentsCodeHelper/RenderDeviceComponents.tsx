                        ...
                        case 4:
                            return <div className="flex flex-col h-screen ">
                                <div className="grid place-items-center mx-2 my-20 sm:my-auto">
                                    <div className="w-full p-12 px-6 py-10 sm:px-10 sm:py-6 bg-gray-400 rounded-lg shadow-md lg:shadow-lg">
                ...
                const renderComponentDesignForStatics = () => {
                    switch (codevalue) {
                        ...
                        case 1:
                            return <section className="text-gray-600 body-font">
                                <div className="container px-5 py-24 mx-auto flex flex-wrap">
                                    <div className="flex flex-wrap  mt-auto mb-auto sm:pr-10">
                                        ...
                                        <div className="p-4">
                                            <h2 className="title-font font-medium text-xl text-gray-500">2.7K</h2>
                                            <p className={`leading-relaxed ${colorClass}`}>Users</p>
                                        </div>
                                        <div className="p-4 ">
                                            <h2 className="title-font font-medium text-xl text-gray-500">1.8K</h2>
                                            <p className={`leading-relaxed ${colorClass}`}>Subscribes</p>
                                        </div>
                                        <div className="p-4">
                                            <h2 className="title-font font-medium text-xl text-gray-500">35</h2>
                                            <p className={`leading-relaxed ${colorClass}`}>Downloads</p>
                                        </div>
                                        <div className="p-4">
                                            <h2 className="title-font font-medium text-xl text-gray-500">4</h2>
                        ...
                        case 2:
                            return <section className="text-gray-600 body-font">
                                <div className="container px-5 py-24 mx-auto">
                                    ...
                                    <div className={`flex flex-wrap text-center ${colorClass}`}>
                                        <div className="p-4 sm:w-1/2 w-full">
                                            <div className="border-2 border-gray-200 px-4 py-6 rounded-lg">
                                                ...
                                                <h2 className="title-font font-medium text-xl text-gray-500">3.5K</h2>
                                        ...
                                        <div className="p-4  sm:w-1/2 w-full">
                                            <div className="border-2 border-gray-200 px-4 py-6 rounded-lg">
                                                ...
                                                <h2 className="title-font font-medium text-xl text-gray-500">2.1K</h2>
                                        ...
                                        <div className="p-4 sm:w-1/2 w-full">
                                            <div className="border-2 border-gray-200 px-4 py-6 rounded-lg">
                                                ...
                                                <h2 className="title-font font-medium text-xl text-gray-500">89</h2>
                                        ...
                                        <div className="p-4  sm:w-1/2 w-full">
                                            <div className="border-2 border-gray-200 px-4 py-6 rounded-lg">
                                                ...
                                                <h2 className="title-font font-medium text-xl text-gray-500">57</h2>
                        ...
                        case 3:
                            return <div className="w-full flex justify-center items-center">
                                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:py-24 lg:px-8">
                                    <h2 className={`text-2xl font-extrabold tracking-tight sm:text-2xl ${colorClass}`}>
