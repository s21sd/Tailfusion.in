...
const Designone = ({ valueOfTheComponent, codevalue, selectColor }: { valueOfTheComponent: number, codevalue: number, selectColor: string }) => {
    ...
    const RenderComponentsBasedOnTheValueOfTheComponent = () => {
        switch (valueOfTheComponent) {
                    ...
                    switch (codevalue) {
                        case 0:
                            return <section className='text-gray-600'>
                                <div className="px-6 py-10 mx-auto">
                                    <h1 className={`text-3xl font-semibold capitalize lg:text-4xl ${colorClass}`}>explore our <br></br> awesome
                        ...
                        case 4:
                            return <section className="text-gray-600 body-font">
                                <div className="container px-5 py-24 mx-auto">
                                    <div className="text-center mb-20">
                                        <h1 className={`sm:text-3xl text-2xl font-medium text-center title-font ${colorClass} mb-4`}>Unique Handcrafted Items</h1>
                                    ...
                                    <div className="flex flex-wrap -m-4">
                                        <div className="p-4 lg:w-1/4 sm:w-1/2 w-full">
                                            <h2 className={`font-medium title-font tracking-widest ${colorClass} mb-4 text-sm text-center sm:text-left`}>Artisanal Jewelry</h2>
                                    ...
                                    <div className="lg:flex lg:items-start lg:gap-8">
                                        ...
                                        <div className="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
                                            ...
                                            <div className="col-span-2 sm:col-span-1">
                                                ...
                                                <ul className="mt-6 space-y-4 text-sm">
                                                    <li>
                                                        <p className="text-gray-700 transition hover:opacity-75"> Marketing Calendar </p>
                                                    </li>

                                                    <li>
                                                        <p className="text-gray-700 transition hover:opacity-75"> SEO Infographics </p>
                                                    </li>
                                                </ul>
                                            </div>
                            ...
                            return <div className="w-full min-h-screen flex items-center justify-center">
                                <div className="md:w-2/3 w-full px-4 flex flex-col">
                                    <div className="w-full text-7xl font-bold">
                                        <h1 className={`w-full md:w-2/3 ${colorClass}`}>How can we help you. get
                                            in touch</h1>
                                    </div>
                    ...
                    switch (codevalue) {
                                ...
                                <div className="container px-5 py-24 mx-auto flex flex-wrap">
                                    <div className="flex flex-wrap -mx-4 mt-auto mb-auto lg:w-1/2 sm:w-2/3 content-start sm:pr-10">
                                        <div className="w-full sm:p-4 px-4 mb-6">
                                            <h1 className={`title-font font-medium text-xl mb-2 ${colorClass}`}>Moon hashtag pop-up try-hard offal truffaut</h1>
                                        ...
                                        <div className="p-4 sm:w-1/2 lg:w-1/4 w-1/2">
                                            <h2 className="title-font font-medium text-3xl text-gray-500">2.7K</h2>
                                            <p className={`leading-relaxed ${colorClass}`}>Users</p>
                                        </div>
                                        <div className="p-4 sm:w-1/2 lg:w-1/4 w-1/2">
                                            <h2 className="title-font font-medium text-3xl text-gray-500">1.8K</h2>
                                            <p className={`leading-relaxed ${colorClass}`}>Subscribes</p>
                                        </div>
                                        <div className="p-4 sm:w-1/2 lg:w-1/4 w-1/2">
                                            <h2 className="title-font font-medium text-3xl text-gray-500">35</h2>
                                            <p className={`leading-relaxed ${colorClass}`}>Downloads</p>
                                        </div>
                                        <div className="p-4 sm:w-1/2 lg:w-1/4 w-1/2">
                                            <h2 className="title-font font-medium text-3xl text-gray-500">4</h2>
                                            <p className={`leading-relaxed ${colorClass}`}>Products</p>
                                        </div>
                                    </div>
                        ...
                        case 2:
                            return <section className="text-gray-600 body-font">
                                <div className="container px-5 py-24 mx-auto">
                                    <div className="flex flex-col text-center w-full mb-20">
                                        <h1 className={`sm:text-3xl text-2xl font-medium title-font mb-4 ${colorClass}`}>Innovative Tech Solutions</h1>
                                        <p className="lg:w-2/3 mx-auto leading-relaxed text-base">
                                    ...
                                    <div className={`flex flex-wrap -m-4 text-center ${colorClass}`}>
                                        <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
                                            <div className="border-2 border-gray-200 px-4 py-6 rounded-lg">
                                                ...
                                                <h2 className="title-font font-medium text-3xl text-gray-500">3.5K</h2>
                                        ...
                                        <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
                                            <div className="border-2 border-gray-200 px-4 py-6 rounded-lg">
                                                ...
                                                <h2 className="title-font font-medium text-3xl text-gray-500">2.1K</h2>
                                        ...
                                        <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
                                            <div className="border-2 border-gray-200 px-4 py-6 rounded-lg">
                                                ...
                                                <h2 className="title-font font-medium text-3xl text-gray-500">89</h2>
                                        ...
                                        <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
                                            <div className="border-2 border-gray-200 px-4 py-6 rounded-lg">
                                                ...
                                                <h2 className="title-font font-medium text-3xl text-gray-500">57</h2>
                        ...
                        case 3:
                            return <div className="w-full flex justify-center items-center">
                                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:py-24 lg:px-8">
                                    <h2 className={`text-3xl font-extrabold tracking-tight sm:text-4xl ${colorClass}`}>
                                        Our Performance Metrics
                                    </h2>
                                    <div className="grid grid-cols-1 gap-5 sm:grid-cols-4 mt-4">
                                        <div className="bg-gray-700 overflow-hidden shadow sm:rounded-lg">
                                            <div className="px-4 py-5 sm:p-6">
                                                <dl>
                                                    <dt className={`text-sm leading-5 ${colorClass} font-medium truncate`}>
                                                        Total Projects
                                                    </dt>
            ...
            case 15:
                const renderComponentDesignForTestimonials = () => {
                    switch (codevalue) {
                        case 0:
                            return <section className="text-gray-600  body-font">
                                <div className="container px-5 py-24 mx-auto">
                                    <h1 className={`text-4xl font-bold title-font mb-12 text-center ${colorClass}`}>Client Testimonials</h1>
                                    <div className="flex flex-wrap -m-4">
                                        <div className="p-4 md:w-1/2 w-full">
                                            <div className="h-full bg-gray-700 bg-opacity-60 p-8 rounded-lg shadow-lg">
                                                ...
                                                <a className="inline-flex items-center">
                                                    ...
                                                    <span className="flex-grow flex flex-col pl-4">
                                                        <span className={`title-font font-semibold ${colorClass}`}>Alex Johnson</span>
                                        ...
                                        <div className="p-4 md:w-1/2 w-full">
                                            <div className="h-full bg-gray-700 bg-opacity-60 p-8 rounded-lg shadow-lg">
                                                ...
                                                <a className="inline-flex items-center">
                                                    <img alt="testimonial" src="https://dummyimage.com/106x106" className="w-12 h-12 rounded-full flex-shrink-0 object-cover object-center" />
                                                    <span className="flex-grow flex flex-col pl-4">
                                                        <span className={`title-font font-semibold ${colorClass}`}>Jordan Lee</span>
                            ...
                            return <section className="text-gray-600 body-font">
                                <div className="container px-5 py-24 mx-auto">
                                    <div className="xl:w-1/2 lg:w-3/4 w-full mx-auto text-center">
                                        ...
                                        <span className={`inline-block h-1 w-10 rounded ${selectBtnColorClass} mt-8 mb-6`}></span>
                                        <h2 className={`${colorClass} font-medium title-font tracking-wider text-sm`}>Alex Johnson</h2>
                                    ...
                                    <div className="flex flex-wrap -m-4">
                                        <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
                                            <div className="h-full text-center">
                                                ...
                                                <span className={`inline-block h-1 w-10 rounded ${selectBtnColorClass} mt-6 mb-4`}></span>
                                                <h2 className={`${colorClass} font-medium title-font tracking-wider text-sm`}>Jamie Lee</h2>
                                        ...
                                        <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
                                            <div className="h-full text-center">
                                                ...
                                                <span className={`inline-block h-1 w-10 rounded ${selectBtnColorClass} mt-6 mb-4`}></span>
                                                <h2 className={`${colorClass} font-medium title-font tracking-wider text-sm`}>Morgan Taylor</h2>
                                        ...
                                        <div className="lg:w-1/3 lg:mb-0 p-4">
                                            <div className="h-full text-center">
                                                ...
                                                <span className={`inline-block h-1 w-10 rounded ${selectBtnColorClass} mt-6 mb-4`}></span>
                                                <h2 className={`${colorClass} font-medium title-font tracking-wider text-sm`}>Samantha Green</h2>
                ...
                return renderComponentDesignForTestimonials();
            default:
                return ''
